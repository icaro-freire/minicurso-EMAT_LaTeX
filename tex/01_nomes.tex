...
%    Seção~\ref{sec:usando}. Sim\ldots mas como eu uso?\\
%    Seção~\ref{sec:overleaf}. Overleaf: um editor online notável\\
%  \end{tabularx}
%\end{margintable}
...
\nota{
  ...
  será publicado ou impresso" (\href{https://www.tecmundo.com.br/institucional/2057-o-que-e-wysiwyg-.htm}{\textcolor{azulUFRB}{TECMUNDO}}, 
  acesso em 03/02/2022).\\
  Se você quiser saber como pronunciar corretamente essa sigla, acesse:
  \href{https://youtu.be/GZuZxwIjh4I}{\textcolor{azulUFRB}{How to pronounce WYSIWYG}}.
} 
...
\begin{table}[!h]
  ...
  \begin{tabular}{ll}
    \toprule
    \multicolumn{1}{p{2cm}}{\centering\textbf{Editor}}              & \multicolumn{1}{p{9.5cm}}{\centering\textbf{Algumas características}}\\
    \midrule
      \href{https://www.texstudio.org/}{\textbf{\TeX studio}}       & \multicolumn{1}{p{9.5cm}}{Destaca-se por ser multiplataforma e com muitos recursos.}\\
      \href{https://www.texniccenter.org/}{\textbf{\TeX nicCenter}} & \multicolumn{1}{p{9.5cm}}{É voltado para usuários de Windows. Integra-se muito naturalmente ao sistema (e ainda indica o Sumatra para visualização do PDF).}\\
      \href{https://www.lyx.org/}{\textbf{LyX}}                     & \multicolumn{1}{p{9.5cm}}{Esse é um editor diferente dos citados anteriormente; pois renderiza as equações e estruturas do texto de forma quase imediata. É o mais próximo, para \LaTeX, de editores WYSIWYG.}\\
    \bottomrule
  \end{tabular}
\end{table}
...
\nota{
  ...
  \href{https://papeeria.com/}{\textcolor{azulUFRB}{Papeeria}} ou
  \href{https://www.authorea.com/}{\textcolor{azulUFRB}{Authorea}}, por exemplo.
}
...
\begin{figure}[!htbp]
  ...
  {
    \includegraphics[width = 0.9\linewidth]{overleaf_inicio}
  }
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width = 0.9\linewidth]{overleaf_panorama-EN}
...
\texttt{pdflatex} -- que é o padrão do \Overleaf), mas, antes, vamos connhecer 
...
Então, agora, resta-nos aprender a linguagem propriamente dita!